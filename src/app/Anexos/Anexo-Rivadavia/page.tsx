...
export default function Rivadavia() {
  ...
  useEffect(() => {
    const fetchSubdependencias = async () => {
      try {
        const data = await obtenerSubdependencias(903); // Verificá que este sea el ID correcto
    ...
    <main className="min-h-screen px-6 py-10 bg-gradient-to-br from-gray-100 via-blue-50 to-gray-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-center text-3xl md:text-4xl font-extrabold text-blue-900 dark:text-white mb-10">
          903 ANEXO RIVADAVIA : RIVADAVIA N° 938
        </h1>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          <div className="w-full h-[400px] rounded-xl overflow-hidden shadow-lg border border-blue-200 dark:border-gray-700">
            <iframe
              title="Mapa Rivadavia 938"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3545.9600000000005!2d-66.85400000000001!3d-29.415500000000005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x96834ddaf3c6c289%3A0x0!2sRivadavia%20938%2C%20La%20Rioja!5e0!3m2!1ses-419!2sar!4v1715000000000!5m2!1ses-419!2sar"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
