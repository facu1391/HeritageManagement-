...
export default function Urquiza() {
  ...
  useEffect(() => {
    const fetchSubdependencias = async () => {
      try {
        const data = await obtenerSubdependencias(909); // Ajustá el ID si es distinto
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          <div className="w-full h-[400px] rounded-xl overflow-hidden shadow-lg border border-blue-200 dark:border-gray-700">
            <iframe
              title="Mapa Urquiza 453"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3545.962345678!2d-66.85000000000001!3d-29.413500000000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x96834ddc66bdf97f%3A0x0!2sUrquiza%20453%2C%20La%20Rioja!5e0!3m2!1ses!2sar!4v1715012345678!5m2!1ses!2sar"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
